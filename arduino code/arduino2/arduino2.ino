...
#define MCUNAME "arduino2"    // nome directory mqtt primario
...
byte mac[]    = {  0x00, 0x08, 0xDC, 0xC1, 0x0D, 0x02 };      // imposta il mac address della LAN
IPAddress iplan (192, 168, 1, 102);                           // imposta l'indirizzo IP della LAN
...
String datainput = "FFFFFFFFFFFF";
String pinstatus = "FFFFFFFFFFFF";
uint8_t delivery = 0;
uint8_t fail = 0;
